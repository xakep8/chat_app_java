    ...
    <div className="flex items-center justify-center min-h-screen w-screen p-6">
      <div className="w-full max-w-[440px] bg-slate-800/70 backdrop-blur-md border border-white/10 rounded-2xl p-8 sm:p-10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)]">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-semibold mb-2 tracking-tight text-slate-50">Welcome back</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <div className="flex flex-col gap-1.5 mb-4">
            <div className="flex justify-between items-center">
              ...
              <a href="#" className="text-sm font-medium text-indigo-500 hover:text-indigo-400 transition-colors">Forgot password?</a>
            </div>
            <div className="relative flex items-center group">
        ...
        <div className="mt-8 text-center text-sm text-slate-400 pt-6 border-t border-white/10">
          <p>Don't have an account? <Link to="/signup" className="font-medium text-indigo-500 hover:text-indigo-400 transition-colors">Sign up for free</Link></p>
        </div>
      </div>
    </div>
  );
